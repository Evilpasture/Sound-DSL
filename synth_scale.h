...
// Octave 8 (Piercing / Hearing Test / Biological Limit)
[[maybe_unused]] static constexpr float 
    C8 = 4186.01f, Cs8 = 4434.92f, Db8 = 4434.92f, D8 = 4698.63f, Ds8 = 4978.03f, Eb8 = 4978.03f,
    E8 = 5274.04f, F8 = 5587.65f,  Fs8 = 5919.91f, Gb8 = 5919.91f, G8 = 6271.93f, Gs8 = 6644.88f, 
    Ab8 = 6644.88f, A8 = 7040.00f, As8 = 7458.62f, Bb8 = 7458.62f, B8 = 7902.13f;

// Octave 9 (High Frequency Buzz)
[[maybe_unused]] static constexpr float 
    C9 = 8372.01f, D9 = 9397.27f, E9 = 10548.08f;

// ==========================================
// RHYTHM DURATIONS (Base: 120 BPM)
// ==========================================
// 60 seconds / 120 beats = 0.5s per beat
[[maybe_unused]] static constexpr float W   = 2.0f;     // Whole Note (4 beats)
[[maybe_unused]] static constexpr float H   = 1.0f;     // Half Note (2 beats)
[[maybe_unused]] static constexpr float Hd  = 1.5f;     // Dotted Half (3 beats)
[[maybe_unused]] static constexpr float Q   = 0.5f;     // Quarter Note (1 beat)
[[maybe_unused]] static constexpr float Qd  = 0.75f;    // Dotted Quarter (1.5 beats)
[[maybe_unused]] static constexpr float E   = 0.25f;    // Eighth Note (0.5 beats)
[[maybe_unused]] static constexpr float Ed  = 0.375f;   // Dotted Eighth (0.75 beats)
[[maybe_unused]] static constexpr float S   = 0.125f;   // Sixteenth Note (0.25 beats)
[[maybe_unused]] static constexpr float T32 = 0.0625f;  // Thirty-Second Note